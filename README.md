...
1. weefee.sh
   Adalah script yang ditulis untuk melakukan pendeteksian, peretasan, dan penetrasi pada
   sebuah jaringan nirkabel (WiFi). Adapun script ini memiliki fitur untuk meretas WPA,
   WPA2, dan WEP. Script ini masih dalam pengembangan. Silakan baca TODO untuk mengetahui
   project kami selanjutnya.
2. deectee.sh
   Adalah script yang terinspirasi dari script CUPP dan WYD, namun kami perbarui dan kami
   tambahkan beberapa fitur di dalamnya. Semisal l33t kata-kata. Remove spasi di depan
   password, remove komentar, split atau menggabungkan wordlsit(s), dan menghapus karakter
   non-ASCII di dalam wordlsit. Script ini sudah dalam versi stabil, namun masih butuh
   penambahan beberapa fitur. Silakan baca TODO untuk mengetahui project kami selanjutnya.
3. trigger.sh
   Adalah BASH script yang berfungsi untuk mempermudah kita dalam melakukan UPDATE pada
   beberapa tools dalam BackTrack yang tidak tersedia setiap hari di repository utama,
   seperti Metasploit Framework, SQLMap, Social Engineering Toolkit, W3AF, dan Exploit-DB.
   Script ini sudah dalam versi paling stabil, namun masih butuh beberapa penambahan dalam
   fiturnya. Silakan baca TODO untuk mengetahui project kami selanjutnya.
4. nakedsec.sh
   Adalah script yang dirancang untuk mengecek sistem keamanan dari sebuah sistem, kita
...
===================================================================================================
                                     Best regard: t193r
blusp10it | red-dragon | v10l3t | m0nst3r | mp1k | b0t4x | 'eko | f1r3-c0d3 | alit | burhan | tofik
===================================================================================================
```